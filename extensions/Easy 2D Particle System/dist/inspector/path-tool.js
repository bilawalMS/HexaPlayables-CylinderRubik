...
exports.PathTool = void 0;
const paper_1 = __importDefault(require("paper"));
const base_tool_1 = require("./base-tool");
const HANDLE_SIZE = 5;
class PathTool extends base_tool_1.BaseTool {
    constructor() {
        super(...arguments);
    ...
    canUse() {
        if (!this.system.value.pathOvertime) {
            return false;
        }
        return this.system.value.pathOvertime.value.enabled.value;
    }
    onRestore() {
        this._shape.removeSegments();
        let poses = this.system.value.pathOvertime.value.poses.value;
        this.enableCurve = this.system.value.pathOvertime.value.curveMode.value;
    ...
    onMouseUp(event) {
        const poses = this.system.value.pathOvertime.value.poses;
